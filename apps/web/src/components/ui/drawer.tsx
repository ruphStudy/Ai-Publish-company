...
>(({ className, children, side = 'right', ...props }, ref) => (
  <DrawerPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 flex h-full max-h-screen w-full max-w-md flex-col bg-background shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300',
        side === 'right'
...
const DrawerFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col-reverse gap-2 p-6 pt-4 border-t sm:flex-row sm:justify-end', className)} {...props} />
);
